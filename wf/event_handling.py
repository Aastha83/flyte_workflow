...
image_spec = ImageConfig(
    default_image="aasthathorat577/flyte-repo:latest"
)


# Function to list folders in a bucket
# @task(container_image="aasthathorat577/flyte-repo:latest", retries=2, timeout=timedelta(minutes=5))
...
def check_execution_status_and_notify():
    config = Config.auto()
...
@task(container_image="aasthathorat577/flyte-repo:latest", retries=2, timeout=timedelta(minutes=10))
...
@task(container_image="aasthathorat577/flyte-repo:latest", retries=2, timeout=timedelta(minutes=20))
...
@task(container_image="aasthathorat577/flyte-repo:latest")
...
@dynamic(container_image="aasthathorat577/flyte-repo:latest")
